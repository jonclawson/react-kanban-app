...
export default function TaskForm({ setSelectedCharId, selectedCharId, characters, onCharType, handleAddItem, title, setTitle, desc, setDesc }: {
  setSelectedCharId: React.Dispatch<React.SetStateAction<string>>;
  selectedCharId: string;
  characters: Character[];
  onCharType: (query: string) => void;
